...
public class ManageMember extends javax.swing.JFrame {
    ...
    public ManageMember() {
        initComponents();
        //adding data into the table by extracting data from server's member database
        try {
            Connection con = DB.myCon();
            Statement S = con.createStatement();
            DefaultTableModel tb = (DefaultTableModel) Customer.getModel();
            tb.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Current Member Details");
        ...
        jButton2.setText("Edit Existing Member");
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/print_icon.png"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/view.png"))); // NOI18N
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            Connection con = DB.myCon();
            Statement S = con.createStatement();
            String reportSource="src\\Reports\\Member_Management.jrxml";
            ...
            Logger.getLogger(ManageMember.class.getName()).log(Level.SEVERE, null, e);
        }
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here: 
        //view detail inmember table
        try {
            Connection con = DB.myCon();
            Statement S = con.createStatement();
            DefaultTableModel tb = (DefaultTableModel) Customer.getModel();
